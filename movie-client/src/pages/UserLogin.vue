    ...
    <q-card class="login-card" style="width: 400px; max-width: 90vw">
      ...
      <q-card-section class="text-center">
        <p>
          ...
          <router-link to="/register" class="text-red">Register here</router-link>
        </p>
      </q-card-section>
    </q-card>
  </q-page>
...
// Simple validation (optional: use vuelidate)
const validateForm = () => {
  return form.value.email && form.value.password.length >= 8
}
